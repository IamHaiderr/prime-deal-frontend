...
const IncomeDetail = () => {
  ...
  const [selfDeposite, setselfDeposite] = useState(0);
  const [teamDeposite, setteamDeposite] = useState(0);
  ...
  const cvbn = (e) => {
    setselfDeposite(e);
    let b = parseFloat(selfDeposite) + parseFloat(teamDeposite);
  }
...
//  setTotalAmount = selfDeposite + teamDeposite;
 ...
 customerList.map((val, i) => {
  ...
  const modal=()=>{
    ...
    //   <input type='number'  placeholder='Self Deposite' id = "self" onChange={(e)=>cvbn(e.target.value)} />

    //   <input type='number' placeholder='Team Deposite' id = "team" 
    //     onChange={(e)=>setteamDeposite(e.target.value)} />

    //   <input type='number' placeholder='TDS' onChange={(e)=>setTDS(e.target.value)} />

    //   <input type='text' placeholder='Processing' onChange={(e)=>setProcessing(e.target.value)}  />
    ...
    //     <input type='text' placeholder='Details' onChange={(e)=>setDetail(e.target.value)} />


    //     <button onClick={()=>setAdd(false)} >cancel</button>
    //     <button onClick={()=>setAdd(postIncome())} >Submit</button>
    // </Backdrop>
    ...
    return <Backdrop>
      ...
      <div style={{width:'300px',display:'flex', margin:'10px 8px'}}>
        ...
        <input type='number' placeholder='TDS' onChange={(e)=>setTDS(e.target.value)} style={{
      ...
      <div style={{
        ...
        <button onClick={()=>setAdd(postIncome())} style={{
          background:'#2ecc71',
          padding:'10px 15px',
          fontSize:16,
          borderRadius:10,
